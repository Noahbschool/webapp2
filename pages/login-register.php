    ...
    <main>
        <section id="login-register" class="landingspagina">
            <div class="login-signup-box">
                <form class="login-signup-form" action="">
                    <input type="email" class="signin-input" placeholder="Mail"> <br>
            ...
            <div class="login-signup-box">
                <form class="login-signup-form" action="">
                    <input type="email" class="signin-input" placeholder="Mail"> <br>
                    <input type="password" class="signin-input" placeholder="Password"> <br>
                    <input type="password" class="signin-input" placeholder="Retype password">
                    <input type="submit" class="sign-in" value="Sign in">
                </form>
            </div>
        </section>
