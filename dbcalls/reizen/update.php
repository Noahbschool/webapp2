...
$sql = "UPDATE reizen SET reisnaam = :reisnaam, reisfoto = :reisfoto, reissterren = :reissterren, reisland = :reisland, reisprijs = :reisprijs, reisvertrekdatum = :reisvertrekdatum, reisduur = :reisduur, reisluchthaven = :reisluchthaven, reistype_vlucht = :reistype_vlucht, reistype_verblijf = :reistype_verblijf, features = :features, reispersonen = :reispersonen WHERE reisid = :reisid";
